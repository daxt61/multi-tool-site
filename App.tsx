...
const tools: Tool[] = [
  ...
  },
  {
    ...
    name: "Métronome",
    icon: Activity,
    description: "Un métronome simple et précis",
    Component: Metronome,
    category: "other",
  },
  {
    ...
    icon: Volume2,
    description: "Lire du texte à haute voix (TTS)",
  ...
  },
  {
    ...
    name: "Glassmorphism",
    icon: Layers,
    description: "Générateur de CSS Glassmorphism",
  ...
  },
  {
    ...
    name: "Image en WebP",
    icon: ImageIcon,
    description: "Convertir des images en format WebP",
