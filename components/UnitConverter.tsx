...
const CONVERSIONS: Record<ConversionCategory, Record<string, ConversionUnit>> = {
  ...
  torque: {
    ...
    'Ncm': { name: 'Newton-centimètre (N·cm)', toBase: (v) => v / 100, fromBase: (v) => v * 100 },
    'kgfm': { name: 'Kilogramme-force mètre (kgf·m)', toBase: (v) => v * 9.80665, fromBase: (v) => v / 9.80665 },
    'lbfft': { name: 'Livre-force pied (lbf·ft)', toBase: (v) => v * 1.355818, fromBase: (v) => v / 1.355818 },
    'lbfin': { name: 'Livre-force pouce (lbf·in)', toBase: (v) => v * 0.112985, fromBase: (v) => v / 0.112985 }
  }
};
