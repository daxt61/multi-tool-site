    ...
    <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="relative group">
            <pre className="w-full h-[500px] p-6 bg-slate-900 rounded-3xl overflow-auto font-mono text-sm leading-relaxed text-indigo-300 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent">
              {output || <span className="text-slate-500 italic">Go struct definition will appear here...</span>}
            </pre>
          </div>
        </div>
      </div>
      ...
      <div className="bg-indigo-50 dark:bg-indigo-900/10 p-8 rounded-[2.5rem] border border-indigo-100 dark:border-indigo-900/20 flex items-start gap-4">
        ...
        <div className="space-y-2">
          <h4 className="font-bold dark:text-white">À propos de la conversion JSON en Go</h4>
          <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
            Cet outil génère des structs Go à partir de vos données JSON. Il gère automatiquement le PascalCase pour les noms de champs et ajoute les tags <code>json:"..."</code> pour la désérialisation. Les types sont inférés à partir des valeurs (ex: int, float64, string, bool).
          </p>
        </div>
      </div>
    </div>
