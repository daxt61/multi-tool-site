    ...
    <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center px-1">
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="proto-output" className="text-xs font-black uppercase tracking-widest text-slate-400 cursor-pointer">Protobuf (proto3)</label>
            </div>
      ...
      <div className="bg-indigo-50 dark:bg-indigo-900/10 p-8 rounded-[2.5rem] border border-indigo-100 dark:border-indigo-900/20 flex items-start gap-4">
        ...
        <div className="space-y-2">
          <h4 className="font-bold dark:text-white">À propos de la conversion JSON en Protobuf</h4>
          <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
            Protocol Buffers (Protobuf) est un mécanisme de sérialisation de données structurées neutre vis-à-vis de la langue et de la plateforme. Cet outil génère des définitions de messages <code>proto3</code> à partir de vos données JSON. Les objets imbriqués sont extraits dans leurs propres messages et les tableaux sont marqués comme <code>repeated</code>.
          </p>
        </div>
      </div>
    </div>
