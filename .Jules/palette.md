...
## 2026-02-18 - [ToolView UX & Accessibility Polish]
**Learning:** For a tool-based dashboard, consistent tactile feedback (active:scale-95) and semantic HTML structure (main tag, skip link) are baseline expectations for a "pro" feel. Localizing category metadata in the detail view instead of showing raw IDs significantly improves user trust and interface clarity.
**Action:** Always wrap main content in a <main> tag and ensure metadata shown to users is localized and icon-consistent.
