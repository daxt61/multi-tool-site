    ...
    <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center px-1">
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="php-output" className="text-xs font-black uppercase tracking-widest text-slate-400 cursor-pointer">PHP 8.1+ Classes</label>
            </div>
      ...
      <div className="bg-indigo-50 dark:bg-indigo-900/10 p-8 rounded-[2.5rem] border border-indigo-100 dark:border-indigo-900/20 flex items-start gap-4">
        ...
        <div className="space-y-2">
          <h4 className="font-bold dark:text-white">À propos de la conversion JSON en PHP</h4>
          <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
            Cet outil génère des classes PHP 8.1+ avec des propriétés typées à partir de vos données JSON. Il est conçu pour les versions récentes de PHP utilisant les types natifs.
          </p>
        </div>
      </div>
    </div>
