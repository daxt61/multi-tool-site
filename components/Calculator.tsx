    ...
    switch (action) {
      ...
      case 'n!': {
        if (current < 0 || current > 170) result = NaN;
          ...
          let f = 1;
          for (let i = 1; i <= Math.floor(current); i++) f *= i;
          result = f;
        }
        break;
      }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 text-right overflow-hidden group transition-all focus-within:ring-2 focus-within:ring-indigo-500/20 relative">
            ...
            <div className="text-5xl md:text-6xl font-black font-mono tracking-tighter truncate dark:text-white mb-2">
            ...
            <button
              ...
              className={`absolute top-4 left-4 p-2 rounded-xl transition-all ${
                copied
                  ...
                  : 'bg-white dark:bg-slate-800 text-slate-400 hover:text-indigo-600 border border-slate-100 dark:border-slate-700 opacity-0 group-hover:opacity-100 focus:opacity-100'
              }`}
