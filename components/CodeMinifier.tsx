      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center px-1">
            <label className="text-xs font-black uppercase tracking-widest text-slate-600">Code Original</label>
            <button
              onClick={() => setInput('')}
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center px-1">
            <label className="text-xs font-black uppercase tracking-widest text-slate-600">Version Minifiée</label>
            <button
              onClick={handleCopy}
              disabled={!output}
          ...
          <div className="relative group">
            ...
            {stats.original > 0 && (
              <div className="absolute bottom-6 left-6 right-6 p-4 bg-black/50 backdrop-blur-md rounded-2xl border border-white/10 flex justify-around text-center">
                <div>
                  <div className="text-[10px] font-bold text-slate-600 uppercase tracking-tighter">Réduction</div>
                  <div className="text-xl font-black text-emerald-400">{stats.reduction.toFixed(1)}%</div>
                </div>
                <div className="w-px bg-white/10"></div>
                <div>
                  <div className="text-[10px] font-bold text-slate-600 uppercase tracking-tighter">Avant</div>
                  <div className="text-xl font-black text-slate-300">{stats.original} B</div>
                </div>
                <div className="w-px bg-white/10"></div>
                <div>
                  <div className="text-[10px] font-bold text-slate-600 uppercase tracking-tighter">Après</div>
