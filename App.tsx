...
function MainApp() {
  ...
  const tools: Tool[] = [
    ...
    // Info Pages
    {
      ...
      name: "À propos",
      icon: Info,
      description: "Infos sur le projet",
      component: <About />,
      category: "info",
    },
    {
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 selection:bg-indigo-100 dark:selection:bg-indigo-900/50">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl relative">
        ...
        <header className="flex justify-between items-center mb-16">
          ...
          <div className="flex items-center gap-4">
            <nav className="hidden md:flex items-center gap-6 mr-4">
              <button onClick={() => setSelectedTool("about")} className="text-sm font-medium text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-colors">À propos</button>
              <button onClick={() => setSelectedTool("contact")} className="text-sm font-medium text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-colors">Contact</button>
            </nav>
            <ThemeToggle />
          </div>
        </header>
        ...
        {selectedTool && (
          <button
            onClick={() => setSelectedTool(null)}
            className="mb-8 flex items-center gap-2 text-sm font-semibold text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-colors"
          >
            ...
            <footer className="pt-20 pb-10 border-t border-slate-200 dark:border-slate-800">
              <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                <div className="flex gap-8">
                  <button onClick={() => setSelectedTool("about")} className="text-sm font-medium text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors">À propos</button>
                  <button onClick={() => setSelectedTool("privacy-policy")} className="text-sm font-medium text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors">Confidentialité</button>
                  <button onClick={() => setSelectedTool("contact")} className="text-sm font-medium text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors">Contact</button>
                </div>
              </div>
            </footer>
          </div>
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-2">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 rounded-full text-xs font-bold uppercase tracking-widest">
                    {currentTool && <currentTool.icon className="w-3 h-3" />} {currentTool?.category}
                  </div>
