...
const CONVERSIONS: Record<ConversionCategory, Record<string, ConversionUnit>> = {
  ...
  torque: {
    'Nm': { name: 'Newton-mètre', toBase: (v) => v, fromBase: (v) => v },
    'Ncm': { name: 'Newton-centimètre', toBase: (v) => v * 0.01, fromBase: (v) => v / 0.01 },
    'kgfm': { name: 'Kilogramme-force mètre', toBase: (v) => v * 9.80665, fromBase: (v) => v / 9.80665 },
    'lbfft': { name: 'Livre-force pied', toBase: (v) => v * 1.355818, fromBase: (v) => v / 1.355818 },
    'lbfin': { name: 'Livre-force pouce', toBase: (v) => v * 0.112985, fromBase: (v) => v / 0.112985 }
  }
};
