...
// Sentinel: toolsMap is initialized with Object.create(null) to prevent Prototype Pollution.
...
function ToolView({ favorites, toggleFavorite }: { favorites: string[], toggleFavorite: (e: React.MouseEvent, id: string) => void }) {
  ...
  // Sentinel: Use Object.prototype.hasOwnProperty.call to safely validate toolId from URL.
