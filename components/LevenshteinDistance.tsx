...
import { Copy, Check, Trash2, Info, ArrowLeftRight, Activity } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
        <div className="space-y-4">
          <label htmlFor="str1" className="text-xs font-black uppercase tracking-widest text-slate-400 px-1">
        ...
        <div className="absolute left-1/2 top-[calc(50%-1.5rem)] -translate-x-1/2 z-10 hidden md:block">
          <button
            onClick={handleSwap}
                ...
                <div className="relative z-10 space-y-2">
                  ...
                  <div className="flex items-end gap-3">
                    ...
                    <button
                      ...
                      className="p-2 bg-white/20 hover:bg-white/30 rounded-lg transition-colors mb-1"
                      title={t('common.copy')}
                    >
