...
import { Copy, Check, Trash2, Hash, Type, FileText, AlignLeft, Clock, MessageSquare, BarChart3, Info, Pilcrow } from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
        {[
          ...
          { icon: <Pilcrow className="w-4 h-4" />, label: 'Paragraphes', value: stats.paragraphs },
