...
const tools: Tool[] = [
  ...
  },
  {
    ...
    name: "Métronome",
    icon: Activity,
    description: "Métronome simple et précis (40-240 BPM)",
    Component: Metronome,
    category: "other",
  },
  {
    ...
    name: "Text to Speech",
    icon: Volume2,
    description: "Transformez votre texte en parole avec plusieurs voix",
  ...
  },
  {
    ...
    name: "Glassmorphism",
    icon: Layers,
    description: "Générateur d'effet CSS Glassmorphism en temps réel",
