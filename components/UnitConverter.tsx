...
export function UnitConverter() {
  ...
  const units = useMemo(() => Object.entries(CONVERSIONS[category]), [category]);
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-8 items-center">
        ...
        <div className="flex justify-center">
          <button
            ...
            className="w-12 h-12 bg-indigo-600 text-white rounded-full flex items-center justify-center shadow-lg shadow-indigo-600/20 hover:scale-110 active:scale-95 transition-all group"
          >
