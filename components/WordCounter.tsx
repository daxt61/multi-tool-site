    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
        {[
          ...
          { icon: <Hash className="w-4 h-4 opacity-50" />, label: 'Sans espaces', value: stats.charactersNoSpaces },
          ...
          { icon: <AlignLeft className="w-4 h-4 opacity-50" />, label: 'Paragraphes', value: stats.paragraphs },
