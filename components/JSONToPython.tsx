    ...
    <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center px-1">
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="python-output" className="text-xs font-black uppercase tracking-widest text-slate-400 cursor-pointer">Python Dataclasses</label>
            </div>
      ...
      <div className="bg-indigo-50 dark:bg-indigo-900/10 p-8 rounded-[2.5rem] border border-indigo-100 dark:border-indigo-900/20 flex items-start gap-4">
        ...
        <div className="space-y-2">
          <h4 className="font-bold dark:text-white">À propos de la conversion JSON en Python</h4>
          <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
            Cet outil génère des dataclasses Python 3.7+ à partir de vos données JSON. Il utilise le module <code>dataclasses</code> et <code>typing</code> pour fournir un typage fort. Les noms de propriétés sont automatiquement convertis en <code>snake_case</code> conformément aux conventions Python (PEP 8).
          </p>
        </div>
      </div>
    </div>
