...
const tools: Tool[] = [
  ...
  {
    id: "csv-row-sorter",
    name: "Trieur de Lignes CSV",
    nameEn: "Sort CSV Rows",
    icon: ArrowUpDown,
    description: "Trier les lignes d'un tableau CSV ou TSV selon les valeurs numériques, alphabétiques ou temporelles d'une colonne",
    descriptionEn: "Sort CSV or TSV dataset rows by column index or header name using numeric, alphabetical, date, or length comparison modes",
    Component: CSVRowSorter,
    category: "dev",
    keywords: ["csv", "tsv", "sort", "rows", "order", "columns", "numeric", "alphabetical", "date", "length", "trier", "lignes", "table"],
  },
  ...
  {
    id: "tailwind-to-css",
    name: "Tailwind CSS en CSS",
    nameEn: "Tailwind CSS to CSS",
    icon: Palette,
    description: "Convertir des classes utilitaires Tailwind CSS en déclarations CSS brutes",
    descriptionEn: "Convert Tailwind CSS utility classes into raw CSS styles",
    Component: TailwindToCSS,
    category: "dev",
    keywords: ["tailwind", "css", "converter", "styles", "frontend", "design", "utility"],
  },
  {
    id: "json-to-prisma",
    name: "JSON en Prisma",
