  ...
  const csvToJson = (csv: string) => {
    try {
      ...
      const headers = parseCSVLine(lines[0]).map(h => {
        // Sentinel: Case-insensitively rename potentially dangerous keys to prevent Prototype Pollution.
      ...
      const result = lines.slice(1).map(line => {
        ...
        // Sentinel: Use Object.create(null) to ensure the created object has no prototype,
        // further hardening against Prototype Pollution.
