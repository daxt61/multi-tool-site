...
export function SQLToTypeScript({ initialData, onStateChange }: { initialData?: any; onStateChange?: (state: any) => void }) {
  ...
  const handleConvert = useCallback(() => {
    try {
      ...
      // Bug Fix: Strip line comments (-- ...) and block comments (/* ... */)
      ...
      while ((match = tableRegex.exec(cleanInput)) !== null) {
        ...
        const interfaceName = getSafeInterfaceName(tableName);
        ...
        const fields = filteredLines.map(line => {
          ...
          return `  ${name}${isNullable ? '?' : ''}: ${mapSqlTypeToTs(type || 'any')};`;
        }).filter(Boolean);
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center px-1">
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="sql-input" className="text-xs font-black uppercase tracking-widest text-slate-400 cursor-pointer">{t('sqltots.sql_input_label')}</label>
            </div>
            <div className="flex items-center gap-2">
          ...
          <textarea
            ...
            placeholder={t('sqltots.placeholder_sql')}
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center px-1">
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="ts-output" className="text-xs font-black uppercase tracking-widest text-slate-400 cursor-pointer">{t('sqltots.ts_interfaces')}</label>
            </div>
          ...
          <textarea
            ...
            value={output}
            readOnly
            placeholder={t('sqltots.placeholder_ts')}
