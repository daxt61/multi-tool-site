...
## 2025-05-25 - [Micro-UX boundaries & Ad Preservation]
**Learning:** Micro-UX improvements must strictly adhere to the 50-line limit and avoid complete component redesigns. Furthermore, `AdPlaceholder` components are critical for the application's structure/monetization and must be preserved during any UI enhancement to avoid regressions.
**Action:** Always verify line counts for micro-UX tasks and ensure specialized components like ads are untouched unless explicitly requested.
