    ...
    <div className="max-w-4xl mx-auto space-y-12">
      ...
      <div className="relative group focus-within:ring-4 focus-within:ring-indigo-500/20 rounded-[2.5rem] transition-all">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity">
          <label htmlFor="color-picker" className="sr-only">Choisir une couleur</label>
          <input
            id="color-picker"
            type="color"
            value={hex}
            onChange={(e) => updateFromHex(e.target.value)}
            className="w-20 h-20 rounded-full border-4 border-white dark:border-slate-800 cursor-pointer shadow-xl overflow-hidden focus:outline-none focus:ring-4 focus:ring-indigo-500 transition-all"
          />
        </div>
      </div>
