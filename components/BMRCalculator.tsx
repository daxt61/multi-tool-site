...
import { Heart, Activity, User, Ruler, Weight, RotateCcw, Info, Check, Zap } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="bg-slate-50 dark:bg-slate-900/50 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center gap-2 text-emerald-500">
